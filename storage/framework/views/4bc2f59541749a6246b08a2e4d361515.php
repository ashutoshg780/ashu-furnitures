            ...
            <div id="productCarousel" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner rounded-4 shadow-sm">
                <div class="carousel-item active">
                  <img src="<?php echo e(asset('images/chair.jpg')); ?>" class="d-block w-100 hero-img" alt="Modern Chair">
                </div>
                <div class="carousel-item">
                  <img src="<?php echo e(asset('images/sofa.jpg')); ?>" class="d-block w-100 hero-img" alt="Stylish Sofa">
                </div>
                <div class="carousel-item">
                  <img src="<?php echo e(asset('images/table.jpg')); ?>" class="d-block w-100 hero-img" alt="Dining Table">
                </div>
                <div class="carousel-item">
                  <img src="<?php echo e(asset('images/desk.jpg')); ?>" class="d-block w-100 hero-img" alt="Office Desk">
                </div>
...
<?php /**PATH C:\xampp\htdocs\my-ecommerce\resources\views/welcome.blade.php ENDPATH**/ ?>